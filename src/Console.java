        ...
        for (int i = 0; i < Game.numberOfBombs && Game.bombs; i++) {
            for (int j = i; j < Game.numberOfBombs; j++) {
                if (Game.bombMatrix[i][j] == 1 && (!Game.bombList.get(i).blast && !Game.bombList.get(j).blast)) {
                    ...
                    g2d.drawLine(Game.bombList.get(i).getX() - Game.bombRadii / 2,
                            Game.bombList.get(i).getY() - Game.bombRadii / 2,
                            Game.bombList.get(j).getX() - Game.bombRadii / 2,
        ...
        for (int i = 0; i < Game.numberOfBombs && Game.bombs; i++) {
            if (!Game.bombList.get(i).blast) {
                if (!Game.bombList.get(i).timerActivated) {
                    ...
                    g2d.fillRect(Game.bombList.get(i).getX() - Game.bombRadii / 2,
                            Game.bombList.get(i).getY() - Game.bombRadii / 2, Game.bombRadii, Game.bombRadii);
                } else {
